            ...
            if country:
                try:
                    country_accordian = driver.find_element(
                        By.XPATH, '(//div[@class="zp-accordion zp__jgHx zp_BOvnT"])[3]'
                    )
                    action.move_to_element(country_accordian).click().perform()
                    country_input = driver.find_element(
                        By.XPATH,
                        '(//div[@class="zp-accordion-body zp_IKT8q"]//input)[2]',
                    )
            ...
            if title:
                try:
                    title_accordian = driver.find_element(
                        By.XPATH, '(//div[@class="zp-accordion zp__jgHx zp_BOvnT"])[2]'
                    )
            ...
            if company:
                try:
                    company_accordian = driver.find_element(
                        By.XPATH, '(//div[@class="zp-accordion zp__jgHx zp_BOvnT"])[4]'
                    ).click()
                    wait.until(
                        EC.presence_of_element_located(
                            (
            ...
            if industry:
                try:
                    industry_accordian = driver.find_element(
                        By.XPATH, '(//div[@class="zp-accordion zp__jgHx zp_BOvnT"])[5]'
                    ).click()
                    wait.until(
                        EC.presence_of_element_located(
                            (
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if is_weekday() == True:
            if datetime_time(5, 1) <= current_time < datetime_time(20, 30):
                print("Starting Code..")
                start_code()
        else:
